...
import { RequiredLableIcon } from "@/components/RequiredLableIcon";
...
export function ProductCustomizationForm({
  ...
  async function onSubmit(values: z.infer<typeof productCustomizationSchema>) {
    ...
    if (data?.message) {
      toast(data.error ? data.error : "Success");
    }
  }
  ...
  return (
    <>
      ...
      <Form {...form}>
        ...
        >
          <div className="frid gap-8 grid-cols-1 md:grid-cols-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Dealfit Discount Message <RequiredLableIcon />
                  </FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={(field) => (
                  <FormItem>
                    <FormLabel>
                      Banner Container <RequiredLableIcon />
                    </FormLabel>
                    <FormControl>
                      <Input disabled={!canCustomizeBanner} {...field} />
                    </FormControl>
